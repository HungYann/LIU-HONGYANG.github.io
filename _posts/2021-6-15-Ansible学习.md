...
可在 task 中定义其它的 roles 文件，具体参考 roles 的使用文档.

####

使用`-include`来包含同路径目录下的其它文件
...
galaxy.ansible.com/home 网站可以存储 ansible 文件
